...
def attrition_summary():
    ...
    return (
        ...
        .join(departments, on="department_id", how="left")
        .groupBy("period", "department_id", "department_name")
...
def workforce_movements():
    ...
    return (
        ...
        .join(
            ...
            on="from_department_id", how="left"
        )
        .join(
    ...
    return (
        ...
        .withColumn(
            ...
            F.round(
                ...
                F.sum("employee_count").over(
                    __import__("pyspark.sql.window", fromlist=["Window"])
                    .Window.partitionBy("period", "department_id")
                ) * 100,
                2
            )
        )
...
# DBTITLE 1, data_quality_review — steward daily review view
@dlt.table(
